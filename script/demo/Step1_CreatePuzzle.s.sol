...
contract Step1_CreatePuzzle is Script {
    ...
    uint256 constant TOTAL_AMOUNT = 0.002 ether; // bounty + collateral
    uint256 constant BOUNTY = 0.0001 ether; // MIN_BOUNTY
    ...
    function run(address gameAddress) external {
        ...
        uint256 puzzleId = game.createPuzzle{value: TOTAL_AMOUNT}(COMMITMENT, BOUNTY, STAKE_REQUIRED, MAX_NUMBER);
        ...
        console.log("Collateral:", TOTAL_AMOUNT - BOUNTY);
