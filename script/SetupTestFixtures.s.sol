...
contract SetupTestFixtures is Script {
    ...
    function createTestPuzzles() internal {
        ...
        uint256 puzzle0 = guessGame.createPuzzle{value: 0.01 ether}(commitment1, 0.0001 ether, 0.001 ether, 100);
        vm.stopBroadcast();
        ...
        uint256 puzzle1 = guessGame.createPuzzle{value: 0.1 ether}(commitment2, 0.0001 ether, 0.01 ether, 100);
        vm.stopBroadcast();
        ...
        uint256 puzzle2 = guessGame.createPuzzle{value: 0.05 ether}(commitment3, 0.0001 ether, 0.005 ether, 100);
        vm.stopBroadcast();
        ...
        uint256 puzzle3 = guessGame.createPuzzle{value: 0.01 ether}(commitment4, 0.0001 ether, 0, 100); // 0 stake = free
        vm.stopBroadcast();
        ...
        uint256 puzzle4 = guessGame.createPuzzle{value: 0.2 ether}(commitment5, 0.0001 ether, 0.02 ether, 100);
        vm.stopBroadcast();
        ...
        uint256 puzzle5 = guessGame.createPuzzle{value: 0.02 ether}(commitment6, 0.0001 ether, 0.002 ether, 100);
        vm.stopBroadcast();
